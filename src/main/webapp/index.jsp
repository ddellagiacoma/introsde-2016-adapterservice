...
<body>
	...
	<br>
	<br>
	URL: <a href="/FitbitWeightLogs">/FitbitWeightLogs?access_token=[]&user_id=[]&refresh_token[]&base_date=[yyyy-MM-dd]&end_date=[yyyy-MM-dd]</a> Source: <a href="https://dev.fitbit.com/docs/body/#get-weight-logs">Fitbit Developer</a><br>
